...
if(@$_GET['fdid'] && $_SESSION['key']=='vinitshahdeo') {
$id=@$_GET['fdid'];
...
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='vinitshahdeo') {
$demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='vinitshahdeo') {
$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='vinitshahdeo') {
$name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='vinitshahdeo') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
...
/* Update quiz timer Session attribute */
if(@$_GET['q'] == 'updateTimer')
{
  $timerSecs = intval(stripslashes(strip_tags($_GET['timeRemaining'])));
  $_SESSION['quizTimeRemaining'] = $timerSecs;
}
...
if(@$_GET['q']== 'quiz' && @$_GET['step']== 2) 
{
  ...
  $_SESSION['quizTimeRemaining'] = intval(stripslashes(strip_tags($_POST['timeRemaining'])));
  ...
  else if( $_SESSION['key']!='vinitshahdeo')
  {
